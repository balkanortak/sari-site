            ...
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex items-center gap-3">
                <div className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold transition-all ${
                  step > s ? "bg-green-500 text-white" : step === s ? "bg-[#ffc107] text-gray-900 ring-4 ring-[#ffc10720]" : "bg-gray-100 text-gray-400"
                }`}>
                  {step > s ? "✓" : s}
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#ffc107] focus:ring-1 focus:ring-[#ffc107] transition-colors bg-white"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#ffc107] focus:ring-1 focus:ring-[#ffc107] transition-colors"
                  />
                  <p className="text-xs text-gray-400 mt-1">Örnek: 05321234567</p>
                </div>
                <button
                  type="button"
                  onClick={() => step1Valid && setStep(2)}
                  disabled={!step1Valid}
                  className="w-full bg-[#ffc107] hover:bg-[#e6ac00] text-gray-900 font-bold py-3 rounded-xl transition-colors disabled:opacity-40 disabled:cursor-not-allowed text-sm mt-2"
                >
                  Devam Et
                </button>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#ffc107] focus:ring-1 focus:ring-[#ffc107] transition-colors"
                  />
                  <p className="text-xs text-gray-400 mt-1">Giriş yapmak için kullanacağınız e-posta</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-xl text-sm focus:outline-none focus:ring-1 transition-colors ${
                      form.password_confirm && form.password !== form.password_confirm
                        ? "border-red-300 focus:border-red-400 focus:ring-red-400"
                        : "border-gray-200 focus:border-[#ffc107] focus:ring-[#ffc107]"
                    }`}
                  />
                  {form.password_confirm && form.password !== form.password_confirm && (
                ...
                <div className="flex gap-3 mt-2">
                  ...
                  <button
                    ...
                    disabled={!step2Valid}
                    className="flex-1 bg-[#ffc107] hover:bg-[#e6ac00] text-gray-900 font-bold py-3 rounded-xl transition-colors disabled:opacity-40 disabled:cursor-not-allowed text-sm"
                  >
                    Devam Et
                  </button>
                </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-xl p-4 space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900">{form.city}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                ...
                <div className="flex items-start gap-2">
                  <input
                    type="checkbox"
                    required
                    className="mt-1 w-4 h-4 accent-[#ffc107] rounded shrink-0"
                  />
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    type="submit"
                    disabled={pending}
                    className="flex-1 bg-[#ffc107] hover:bg-[#e6ac00] text-gray-900 font-bold py-3 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                  >
